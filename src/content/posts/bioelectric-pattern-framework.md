...
**Field Coherence Validation.** Monitor your state of coherence. Not conceptually — somatically. Is the chest relaxed and rhythmic, or contracted and arrhythmic? Is the gut settled, or agitated? Coherence is not a metaphor. It is a measurable state of the bioelectric field, and you can detect it without instruments through sustained somatic attention.

**Pattern Recognition Testing.** When a pattern repeats — the same relational dynamic, the same emotional response, the same behavioral sequence — investigate at the field level. Where in the body does the pattern store its charge? What voltage state activates it? The pattern is not "in your head." It is in the field. The field is in the body. The body is accessible to direct observation.
...
The bioelectric field is the body's first and most enduring information system. The nervous system was built on top of it. The cognitive system was built on top of the nervous system. The narrative self was built on top of the cognitive system.

When you try to change a pattern from the narrative level and fail, you are debugging at the wrong layer of the stack. The pattern lives deeper — in the field, in the voltage, in the cellular memory that preceded your first thought and will outlast your last.

The bioelectric pattern framework does not replace cognitive or psychological approaches. It identifies the layer they cannot reach and provides protocols for accessing it directly. The body remembers. The voltage encodes. The field processes.

Learn to read the field and you read the source code of the pattern. Everything above it — thought, emotion, narrative, identity — is compiled output. Useful, but not fundamental. The bioelectric field is the compiler. The pattern is the source. Start there.
