...
Type 5: retreat to analysis, reduce availability, hoard information, minimize surface area.
Type 7: reframe, redirect, generate alternatives to avoid sitting with the discomfort.
Type 1: correct, improve, internally narrate what should have happened.
Type 3: perform, accelerate, produce visible output, shift into competence display.
Type 6: scan for threats, seek reassurance, test loyalty, prepare for the worst case.
