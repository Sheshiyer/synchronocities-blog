...
You need read access to the operating system already executing you.
...
Ba registers the signal before cognition touches it.
La shapes it into a familiar state.
Kha narrates the story you call "my reaction."
...
What's architecture can be mapped.
What's mapped can be interrupted.
What's interrupted becomes material, not fate.
...
Not "who am I?" but:
What defense fires first under load?
