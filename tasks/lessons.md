...
- When the user asks to keep a narrative series but stop making it the main focus, preserve the lane itself, demote its discovery priority, and separate it cleanly from research/maps surfaces instead of blending every archive mode back onto the same page.
